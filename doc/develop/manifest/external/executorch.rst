...
Arm provides the `Ethos-U NPU family <https://www.arm.com/products/silicon-ip-cpu?families=ethos%20npus>`_ for efficient on-device AI inference.
...
.. tabs::
         ...
         .. tabs::
            ...
            .. group-tab:: Ubuntu
               ...
               **Step 1:** Download the FVP installer for Corstone-300 from the
               ...
               `Arm Corstone FVPs <https://developer.arm.com/Tools%20and%20Software/Fixed%20Virtual%20Platforms/IoT%20FVPs>`_
      ...
      .. tabs::
         ...
         .. group-tab:: Windows
            ...
            .. code-block:: console
               ...
               west build -p auto -b mps3/corstone300/fvp modules/lib/executorch/zephyr/samples/hello-executorch -t run -- `
   ...
   .. group-tab:: CPU-only Inference
      ...
      The model used here is a minimal ``add`` model compiled for Cortex-M55.
      From the Zephyr root (for example ``~/zephyrproject``), run:
      ...
      Replace ``<board>`` with your target board:
      ...
      .. note::
         ...
         - **STM Nucleo-N657X0-Q** (``nucleo_n657x0_q``):
           ...
           .. code-block:: console
              ...
              west build -b nucleo_n657x0_q modules/lib/executorch/zephyr/samples/hello-executorch \
         ...
         - **nRF5340 DK** (``nrf5340dk_nrf5340_cpuapp``):
           ...
           .. code-block:: console
              ...
              west build -b nrf5340dk_nrf5340_cpuapp modules/lib/executorch/zephyr/samples/hello-executorch \
                -- -DET_PTE_FILE_PATH=add_m55.pte
...
new samples here: `ExecuTorch Zephyr samples <https://github.com/pytorch/executorch/tree/main/zephyr/samples>`_.
